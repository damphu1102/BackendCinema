...
import com.example.backendcinema.Payment.Config.VnpayConfig;
...
public class VnpayServiceImpl implements VnpayService {
    ...
    public String createPayment(VnpayRequest paymentRequest) throws UnsupportedEncodingException {
        ...
        try {
            amountInCents = Long.parseLong(paymentRequest.getAmount()) * 100;
            amountInCurrency = Long.parseLong(paymentRequest.getAmount()); // Lưu giá trị gốc để set vào Transaction
